...
LOAD DATA LOCAL INFILE 'Terminology/Content/sct1_Concepts_Core_INT_${version}.txt' INTO TABLE concepts LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Terminology/Content/sct1_Descriptions_en_INT_${version}.txt' INTO TABLE descriptions LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Terminology/Content/sct1_Relationships_Core_INT_${version}.txt' INTO TABLE relationships LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Terminology/History/sct1_ComponentHistory_Core_INT_${version}.txt' INTO TABLE componenthistory LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Terminology/History/sct1_References_Core_INT_${version}.txt' INTO TABLE referencescore LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Maps/ICD9/der1_CrossMapSets_ICD9_INT_${version}.txt' INTO TABLE crossmapsetsicd9 LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Maps/ICD9/der1_CrossMapTargets_ICD9_INT_${version}.txt' INTO TABLE crossmaptargetsicd9 LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Maps/ICD9/der1_CrossMaps_ICD9_INT_${version}.txt' INTO TABLE crossmapsicd9 LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Maps/ICDO/der1_CrossMapSets_ICDO_INT_${version}.txt' INTO TABLE crossmapsetsicdo LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@MAPSETID,@MAPSETNAME,@MAPSETTYPE,@MAPSETSCHEMEID,@MAPSETSCHEMENAME,@MAPSETSCHEMEVERSION,@MAPSETREALMID,@MAPSETSEPARATOR,@MAPSETRULETYPE)
SET MAPSETID = @MAPSETID,
MAPSETNAME = @MAPSETNAME,
MAPSETTYPE = @MAPSETTYPE,
...
LOAD DATA LOCAL INFILE 'Maps/ICDO/der1_CrossMapTargets_ICDO_INT_${version}.txt' INTO TABLE crossmaptargetsicdo LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@TARGETID,@TARGETSCHEMEID,@TARGETCODES,@TARGETRULE,@TARGETADVICE)
SET TARGETID = @TARGETID,
TARGETSCHEMEID = @TARGETSCHEMEID,
TARGETCODES = @TARGETCODES,
...
LOAD DATA LOCAL INFILE 'Maps/ICDO/der1_CrossMaps_ICDO_INT_${version}.txt' INTO TABLE crossmapsicdo LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@MAPSETID,@MAPCONCEPTID,@MAPOPTION,@MAPPRIORITY,@MAPTARGETID,@MAPRULE,@MAPADVICE)
SET MAPSETID = @MAPSETID,
MAPCONCEPTID = @MAPCONCEPTID,
MAPOPTION = @MAPOPTION,
...
LOAD DATA LOCAL INFILE 'Subsets/Language-en-GB/der1_Subsets_en-GB_INT_${version}.txt' INTO TABLE subsetsengb LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Subsets/Language-en-GB/der1_SubsetMembers_en-GB_INT_${version}.txt' INTO TABLE subsetmembersengb LINES TERMINATED BY '\r\n' IGNORE 1 LINES
...
LOAD DATA LOCAL INFILE 'Subsets/Language-en-US/der1_Subsets_en-US_INT_${version}.txt' INTO TABLE subsetsenus LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@SUBSETID,@SUBSETORIGINALID,@SUBSETVERSION,@SUBSETNAME,@SUBSETTYPE,@LANGUAGECODE,@REALMID,@CONTEXTID)
SET SUBSETID = @SUBSETID,
SUBSETORIGINALID = @SUBSETORIGINALID,
SUBSETVERSION = @SUBSETVERSION,
...
LOAD DATA LOCAL INFILE 'Subsets/Language-en-US/der1_SubsetMembers_en-US_INT_${version}.txt' INTO TABLE subsetmembersenus LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@SUBSETID,@MEMBERID,@MEMBERSTATUS,@LINKEDID)
SET SUBSETID = @SUBSETID,
MEMBERID = @MEMBERID,
MEMBERSTATUS = @MEMBERSTATUS,
...
LOAD DATA LOCAL INFILE 'Subsets/NonHumanSubset/der1_Subsets_NonHuman_INT_${version}.txt' INTO TABLE subsetsnonhuman LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@SUBSETID,@SUBSETORIGINALID,@SUBSETVERSION,@SUBSETNAME,@SUBSETTYPE,@LANGUAGECODE,@REALMID,@CONTEXTID)
SET SUBSETID = @SUBSETID,
SUBSETORIGINALID = @SUBSETORIGINALID,
SUBSETVERSION = @SUBSETVERSION,
...
LOAD DATA LOCAL INFILE 'Subsets/NonHumanSubset/der1_SubsetMembers_NonHuman_INT_${version}.txt' INTO TABLE subsetmembersnonhuman LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@SUBSETID,@MEMBERID,@MEMBERSTATUS,@LINKEDID)
SET SUBSETID = @SUBSETID,
MEMBERID = @MEMBERID,
MEMBERSTATUS = @MEMBERSTATUS,
...
LOAD DATA LOCAL INFILE 'Subsets/VTMVMP/der1_Subsets_VTMVMP_INT_${version}.txt' INTO TABLE subsetsvtmvmp LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@SUBSETID,@SUBSETORIGINALID,@SUBSETVERSION,@SUBSETNAME,@SUBSETTYPE,@LANGUAGECODE,@REALMID,@CONTEXTID)
SET SUBSETID = @SUBSETID,
SUBSETORIGINALID = @SUBSETORIGINALID,
SUBSETVERSION = @SUBSETVERSION,
...
LOAD DATA LOCAL INFILE 'Subsets/VTMVMP/der1_SubsetMembers_VTMVMP_INT_${version}.txt' INTO TABLE subsetmembersvtmvmp LINES TERMINATED BY '\r\n' IGNORE 1 LINES
(@SUBSETID,@MEMBERID,@MEMBERSTATUS,@LINKEDID)
SET SUBSETID = @SUBSETID,
MEMBERID = @MEMBERID,
MEMBERSTATUS = @MEMBERSTATUS,
