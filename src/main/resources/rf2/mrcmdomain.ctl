...
infile 'Snapshot/Refset/Metadata/der2_sssssssRefset_MRCMDomainSnapshot_${editionLabel}_${editionVersion}.txt' "str X'0d0a'"
...
(
    ...
    domainTemplateForPrecoordination VARCHAR2(5000),
