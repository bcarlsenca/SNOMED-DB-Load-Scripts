...
SELECT id, effectiveTime, active,
    ...
    refsetId, cpn2.preferredName refsetIdName,
    referencedComponentId, cpn3.preferredName referencedComponentIdName,
    domainId, cpn4.preferredName domainIdName,
    grouped, attributeCardinality, attributeInGroupCardinality,
    ruleStrengthId, cpn4.preferredName ruleStrengthIdName,
    contentTypeId, cpn4.preferredName contentTypeIdName
...
SELECT id, effectiveTime, active,
    ...
    refsetId, cpn2.preferredName refsetIdName,
    referencedComponentId, cpn3.preferredName referencedComponentIdName,
    mrcmRuleRefsetId, cpn4.preferredName mrcmRuleRefsetIdName
